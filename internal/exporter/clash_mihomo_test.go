...
// Until now the clash export was only round-trip tested (export → re-import into WakeRoute),
// which proves WakeRoute can re-read its own output but NOT that a mihomo client accepts it.
