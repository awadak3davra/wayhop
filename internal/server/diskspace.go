...
// diskVerdict maps free bytes on WayHop's filesystem to a battery status. The router overlay is
...
// holding the WayHop binary (where the binary swaps and, on most installs, the config lives)
