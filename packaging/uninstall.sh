...
#     (The daemon deliberately LEAVES its kernel plane up across a service restart/upgrade so
#     routing never drops while the panel binary is swapped — uninstall is where it is removed.)
# ===========================================================================
hdr "Network rules"
CLEANED=0
